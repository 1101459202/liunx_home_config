...
set clipboard=unnamed "vim的yank默认使用系统剪贴板
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" 代码缩进和排版
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
let g:ycm_clangd_args=['--header-insertion=iwyu','--all-scopes-completion']
...
" Doxygen
let g:DoxygenToolkit_authorName="cc, 110145@qq.com"
